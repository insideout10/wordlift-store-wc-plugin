...
class Wordlift_Store {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wordlift_Store_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'wordlift-store';
		$this->version = '1.0.0';
	 ...
	 *
	 * - Wordlift_Store_Loader. Orchestrates the hooks of the plugin.
	 * - Wordlift_Store_i18n. Defines internationalization functionality.
	 * - Wordlift_Store_Admin. Defines all hooks for the admin area.
	 * - Wordlift_Store_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wordlift-store-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wordlift-store-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wordlift-store-admin.php';
	 ...
	 *
	 * Uses the Wordlift_Store_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wordlift_Store_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wordlift_Store_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wordlift_Store_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wordlift_Store_Loader    Orchestrates the hooks of the plugin.
	 */
